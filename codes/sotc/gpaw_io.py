"""
GPAW force calculator for SOTC.

Wraps the GPAW DFT code (via ASE) as an SOTC force calculator,
providing the .compute() / .energy() interface expected by SOTCRunner
...
Usage
-----
    from sotc.gpaw_io import GPAWForceCalculator
...
SOTCRunner's ThreadPoolExecutor does not trigger simultaneous GPAW
...
class GPAWForceCalculator:
    """
    In-process GPAW force calculator for SOTC.
