...
=========================================
Python implementation of the SQTC framework for computing phonons and
...
3.  Optimize atomic displacement amplitudes {A_qs} to minimise the
    SQTC quality functional Q[C2^SQTC - C2^target].
