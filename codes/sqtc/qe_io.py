"""
Quantum ESPRESSO force calculator for SQTC.

Wraps the Quantum ESPRESSO pw.x code (via ASE's Espresso calculator) as an
SQTC force calculator, providing the .compute() / .energy() interface
expected by SQTCRunner and mock_vasp_results().
...
class QEForceCalculator:
    """
    Subprocess-based Quantum ESPRESSO force calculator for SQTC.
