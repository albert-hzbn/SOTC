"""
VASP input file writer and output file parser for SQTC single-point calculations.
...
VASP single-point settings used for SQTC:
...
class VASPWriter:
    """
    Write VASP input files for an SQTC single-point force calculation.
    ...
    def write_poscar(
        ...
        comment: str = "SQTC displaced cell",
        direct: bool = False,
    ) -> Path:
        """
        Write POSCAR file.
...
class VASPRunner:
    """
    Run VASP calculations for each SQTC snapshot.
    ...
    def run_ensemble(
        ...
        **kwargs,
        ...
        """
        Run VASP for all snapshots in the SQTC ensemble sequentially.
