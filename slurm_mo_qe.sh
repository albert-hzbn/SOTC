#!/bin/bash -l
#SBATCH -p small
#SBATCH -o sotc_mo_qe.out.%j
#SBATCH -e sotc_mo_qe.err.%j
#SBATCH -D ./
#SBATCH -J sotc_mo_qe
#SBATCH --nodes=1
#SBATCH --ntasks=64
...
# bcc Mo  1500 K  64-atom  — moderate anharmonicity, up to 6 SOTC iterations
...
set -e
python3 codes/benchmarks/run_sotc_mo_qe.py
echo "sotc_mo_qe done."
