#!/bin/bash -l
#SBATCH -p small
#SBATCH -o sotc_w_qe.out.%j
#SBATCH -e sotc_w_qe.err.%j
#SBATCH -D ./
#SBATCH -J sotc_w_qe
#SBATCH --nodes=1
#SBATCH --ntasks=64
...
# bcc W  1500 K  64-atom  — moderate anharmonicity, up to 6 SOTC iterations
...
set -e
python3 codes/benchmarks/run_sotc_w_qe.py
echo "sotc_w_qe done."
